...
码上AI·CoStrict校园挑战赛 创新应用赛-代码写的对不队-线下反诈通
...
## 核心功能
应用启动后，您可以体验以下核心功能：
1. **实时诈骗风险检测**: 实时语音采集与分析，一键开启，有风险时自动弹窗，实时守护您的生命与财产安全。
2. **智拍识诈**: 智能分析海报广告中虚假诈骗内容，精准排查潜在诈骗隐患。
3. **辨诈实战**: 构建AI反诈智能体，可精准模仿骗子的话术逻辑与诱导手段，与用户展开沉浸式的实时对话博弈。
4. **防诈知识闯关**: 用户可根据自身学习需求，一键开启反诈闯关游戏功能，助力筑牢反诈知识防线。
5. **安全工具**: 一键举报，家人速通，定址呼救，集结应急防护工具，为用户筑牢反诈后盾（为避免占用公安资源，暂时为模拟阶段）。
